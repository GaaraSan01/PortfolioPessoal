...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!csrf_check()) { $errors[] = 'Token inválido. Tente novamente.'; goto render; }
        ...
        <form method="POST" class="admin-form" enctype="multipart/form-data">
            ...
            <div class="form-grid-2">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="category" placeholder="Ex: Web Design / Development" value="<?= htmlspecialchars($project['category'] ?? '') ?>" required>
                </div>
                <div class="form-group">
                    <label>Ano</label>
                ...
                <div class="form-group">
                    <label>Status</label>
                    <select name="status">
                        <option value="published" <?= ($project['status'] ?? 'published') === 'published' ? 'selected' : '' ?>>Publicado</option>
            ...
            <div class="form-group">
                ...
                <input type="text" name="image" placeholder="https://... ou projeto.avif" value="<?= htmlspecialchars($project['image'] ?? '') ?>" style="margin-bottom: 8px;">
            ...
            <div class="form-group">
                ...
                <textarea name="long_description" rows="6"><?= htmlspecialchars($project['long_description'] ?? '') ?></textarea>
            </div>

            <div class="form-group">
                <label>Tecnologias (separadas por vírgula)</label>
                <input type="text" name="technologies" placeholder="React, PHP, PostgreSQL" value="<?= htmlspecialchars(implode(', ', $project['technologies'] ?? [])) ?>">
            </div>
